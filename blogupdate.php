...
<div class="row">
<div class="col-md-12">
<form name="contact-form" action="search_blog.php" method="post" id="contact-form">
...
<button type="submit" class="btn btn-primary" name="submit" value="Submit" id="submit_form">SEARCH BLOG</button>
</form>
</div>
</div>
</div>
